		...
		text: function(newText) {
			...
			if(arguments.length) {
                ...
                return $.each(this, function(index, item) {
                    ...
                    item.appendChild(newTextNode.cloneNode()); // we must clone the node or else appendChild will just move it in each loop and only the last item would have the node at the end
