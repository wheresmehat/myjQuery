    ...
    var getText = function(element) {
        ...
        $.each(element.childNodes, function(index, childItem) {
            ...
            if (childItem.nodeType === 3) {
                ...
                allChildrenText += childItem.nodeValue;     // we could use trim() to get rid of whitespace here
	...
	$.extend($.prototype, {
		...
		text: function(newText) {
			...
			if(arguments.length) {
                ...
                this.html("");  // .html("") method loops through all elements of this collection
                ...
                return this[0] && getText(this[0]);    // check if this[0] exists; short-circuit evaluation
            }
