	...
	$.extend($.prototype, {
		...
		find: function(selector) {
			...
			$.each(this, function(index, item) {    
                ...
                var nodeList = item.querySelectorAll(selector);    // item.querySelectorAll(selector) returns back a nodeList of all nodes in each item; so we must iterate over that list using another $.each loop 

                $.each(nodeList, function(index, nodeListElement) { 
