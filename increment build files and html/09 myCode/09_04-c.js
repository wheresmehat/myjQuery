...
(function() {
    ...
    */
    ...
    // makeTraverser had to be changed because find method takes an argument (selector)
    var makeTraverser = function(cb) {
		...
		return function(selector) {
        	...
        	$.each(this, function(index, item) {
            	...
            	cb(elements, item, selector);   // we need to pass selector because find() takes an argument
