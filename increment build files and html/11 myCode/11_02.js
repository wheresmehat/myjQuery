(function() {
	...
	$.extend($.prototype, {
		...
		offset: function() {    
            ...
            var viewOffset = this[0].getBoundingClientRect();
        
            return {

                top: viewOffset.top + window.pageYOffset,
        ...
        unbind: function(eventName, handler) {
            ...
            return $.each(this, function(index, item) {
                ...
                item.removeEventListener(eventName, handler, false);
...
function changeText() {
    ...
    $("p").text("There can be only one!");

}

$("#b1").bind("click", changeText);

$("#b2").bind("click", function() {    // the handler is always called-back in the addEventListener function with the event object as the argument 
